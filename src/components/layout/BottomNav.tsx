...
const OverviewIcon = ({ active }: { active: boolean }) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={active ? '#b8b2f0' : '#555577'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40">
      <div className="glass border-t border-white/[0.06]">
        <div className="max-w-[430px] mx-auto flex items-center justify-around pt-2 pb-[max(0.625rem,env(safe-area-inset-bottom))]">
          {items.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center gap-1 min-w-[64px] py-1 rounded-xl transition-all duration-200 ${
